...
final POVButton xboxButton180 = new POVButton(xboxController1, 180); //Dpad down
xboxButton180.whileTrue(new TurnToAngle( 0, m_driveTrain ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
  SmartDashboard.putData("Turn To Angle",new TurnToAngle( 0, m_driveTrain ));
}
