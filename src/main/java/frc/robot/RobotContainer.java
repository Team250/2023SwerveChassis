...
xboxButton0.whileTrue(new LLAutoCenter(0,m_driveTrain ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
xboxButton270.whileTrue(new LLAutoCenterLeft(0, m_driveTrain ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
xboxButton90.whileTrue(new LLAutoCenterRight(0, m_driveTrain ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
