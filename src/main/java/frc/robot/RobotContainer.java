...
final JoystickButton xboxButtonX = new JoystickButton(xboxController1, XboxController.Button.kX.value); //Dped left   
xboxButtonX.whileTrue(new SequentialCommandGroup(new TurnToAngle(0,m_driveTrain), new LLAutoCenterLeft(m_driveTrain)).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
    // SmartDashboard.putData("LimeLight Auto Center Left",new LLAutoCenterLeft(0, m_driveTrain ));

final JoystickButton xboxButtonB = new JoystickButton(xboxController1, XboxController.Button.kB.value); //Dpad right
xboxButtonB.whileTrue(new SequentialCommandGroup(new TurnToAngle(0,m_driveTrain), new LLAutoCenterRight(m_driveTrain)).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
