...
import frc.robot.commands.Drives.LockDriveLeftRight;
...
public class Drive extends CommandBase {
    ...
    public void execute() {
        ...
        MathUtil.applyDeadband(-RobotContainer.getInstance().getXboxController1().getRightX()
         * m_driveTrain.getRotationLock(), OIConstants.kDriveDeadband), 
        m_driveTrain.getFieldOriented(),true); //Not robot oriented drive, field oriented
