...
public class LLAutoCenterRight extends CommandBase {
    ...
    public LLAutoCenterRight(DriveTrain subsystem) {
    ...
    public void execute() {
        if (LimeLight.isTag() == 1.0){
            if (LimeLight.getXCoord() > -20 
            // && LimeLight.getXCoord() < -40
            ){
                m_driveTrain.setDrive(0, (LimeLight.getXCoord()+1)/100, 0, true, true);
            }
