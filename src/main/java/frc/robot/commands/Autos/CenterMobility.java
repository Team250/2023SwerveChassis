...
public class CenterMobility extends SequentialCommandGroup {
    ...
    public CenterMobility(DriveTrain subsystem) {
        ...
        PathPlannerTrajectory mdMob = PathPlanner.loadPath("Center Mobility", new PathConstraints(0.33, 0.33));
        addCommands(
            ...
            new FollowPathWithEvents(subsystem.followTrajectoryCommand(mdMob, true), mdMob.getMarkers(), eventMap)
        );
    }
}
