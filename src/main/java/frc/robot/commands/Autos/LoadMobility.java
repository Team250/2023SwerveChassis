...
public class LoadMobility extends SequentialCommandGroup {
    ...
    public LoadMobility(DriveTrain subsystem) {
        ...
        PathPlannerTrajectory loadMobility = PathPlanner.loadPath("Loading Mobility", new PathConstraints(0.33, 0.33));
        addCommands(
            new FollowPathWithEvents(subsystem.followTrajectoryCommand(loadMobility, true), loadMobility.getMarkers(), eventMap)
        );
    }
}