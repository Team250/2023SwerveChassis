    ...
    */
    ...
    public void periodic() {
      ...
      m_field.setRobotPose(m_odometry.getPoseMeters());
        ...
        SmartDashboard.putNumber("OffsetAngle # 1", getFieldOffsetAngle());
        SmartDashboard.putNumber("OffsetAngle # 2", fieldOffsetAngle);
...
public Command followTrajectoryCommand(PathPlannerTrajectory pathPlannerTrajectory, boolean isFirstPath) {
  return new SequentialCommandGroup(
       new InstantCommand(() -> {
         ...
         if(isFirstPath){
             this.resetOdometry(pathPlannerTrajectory.getInitialHolonomicPose());
         }
       }),
       new PPSwerveControllerCommand(
          ...
          //  this.kinematics, // SwerveDriveKinematics
           new PIDController(AutoConstants.kDrivingP, AutoConstants.kDrivingI, AutoConstants.kDrivingD), // X controller. Tune these values for your robot. Leaving them 0 will only use feedforwards.
           new PIDController(AutoConstants.kDrivingP, AutoConstants.kDrivingI, AutoConstants.kDrivingD), // Y controller (usually the same values as X controller)
           new PIDController(AutoConstants.kTurningP, AutoConstants.kTurningI, AutoConstants.kTurningD), // Rotation controller. Tune these values for your robot. Leaving them 0 will only use feedforwards.
